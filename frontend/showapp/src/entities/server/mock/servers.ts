...
export const mockServerSnapshots: ServerSnapshot[] = [{
  environment: 'dev',
  timestamp: '2026-04-01 00:02:15',
  project: 'default',
  servers: [
...
, {
  ...
  servers: [
    {
      alias: 'master',
      hostname: 'test-master.myhost.mydomain',
      ipAddress: '10.140.0.23',
      systemInfo: {
        os: {
          prettyName: 'Ubuntu 22.04.4 LTS',
    ...
    {
      alias: 'worker',
      hostname: 'test-worker.myhost.mydomain',
      ipAddress: '10.140.0.21',
      systemInfo: {
        os: {
          prettyName: 'Ubuntu 22.04.4 LTS',
    ...
    {
      alias: 'database',
      hostname: 'test-database.myhost.mydomain',
      ipAddress: '10.140.0.11',
      systemInfo: {
        os: {
          prettyName: 'Ubuntu 22.04.4 LTS',
...
},
{
  ...
  servers: [
    {
      alias: 'master',
      hostname: 'prod-master.myhost.mydomain',
      ipAddress: '10.140.0.23',
      systemInfo: {
        os: {
          prettyName: 'Ubuntu 22.04.4 LTS',
    ...
    {
      alias: 'worker',
      hostname: 'prod-worker.myhost.mydomain',
      ipAddress: '10.140.0.21',
      systemInfo: {
        os: {
          prettyName: 'Ubuntu 22.04.4 LTS',
    ...
    {
      alias: 'database',
      hostname: 'prod-database.myhost.mydomain',
      ipAddress: '10.140.0.11',
      systemInfo: {
        os: {
          prettyName: 'Ubuntu 22.04.4 LTS',
